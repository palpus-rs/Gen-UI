...
use super::{widget::Widget, Model, ToLiveDesign};
...
impl From<&Model> for LiveDesign {
    fn from(value: &Model) -> Self {
        match value {
            Model::AppMain(app_main) => app_main.to_live_design(),
            Model::Widget(widget) => widget.to_live_design(),
        }
    }
}