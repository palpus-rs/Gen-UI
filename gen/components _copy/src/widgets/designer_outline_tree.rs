use {
    crate::{
        ...
        makepad_draw::*,
        widgets::{
            fold_button::*, scroll_bars::ScrollBars, scroll_shadow::DrawScrollShadow, widget::*,
        },
    },
...
impl DesignerOutlineTreeNode {
    pub fn draw(
        ...
        self.draw_bg.begin(
            cx,
            Walk::size(Size::Fill, Size::Fixed(scale * node_height)),
            self.layout,
        );
    ...
    pub fn set_is_open(&mut self, cx: &mut Cx, is: bool, animate: Animate) {
        ...
        self.button_open
            .animator_toggle(cx, is, animate, id!(open.on), id!(open.off));
    }
