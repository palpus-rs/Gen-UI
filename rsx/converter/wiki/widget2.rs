...
EasyWidget = {{EasyWidget}}{  first_lb = <Label>{ draw_text: { color: #ffffff, wrap: Word, text_style: { font_size: 32, brightness: 1.1, font: {path: dep("crate://makepad-widgets/resources/IBMPlexSans-SemiBold.ttf")},  } }} second_lb = <Label>{text: "label 2",  draw_text: { color: #ffffff, wrap: Word, text_style: { brightness: 1.1, font: {path: dep("crate://makepad-widgets/resources/IBMPlexSans-SemiBold.ttf")},  } }} bb = <Button>{text: "text btn", }  }
}
