...
EasyWidget = {{EasyWidget}}{  <Label>{text: "label 1",  draw_text: { color: #ffffff, wrap: Word, text_style: { font_size: 32, font: {path: dep("crate://makepad-widgets/resources/IBMPlexSans-SemiBold.ttf")}, brightness: 1.1,  } }} second_lb = <Label>{text: "label 2",  draw_text: { color: #ffffff, wrap: Word, text_style: { font: {path: dep("crate://makepad-widgets/resources/IBMPlexSans-SemiBold.ttf")}, brightness: 1.1,  } }} bb = <Button>{text: "text btn", }  }
}
