...
struct Instance { pub view_flow: Flow }
impl Instance { pub fn new() -> Self { Self { view_flow: Flow::Down } } pub fn get_view_flow(&self) -> &Flow { &self.view_flow } pub fn set_view_flow(&mut self, view_flow: Flow) { self.view_flow = view_flow } }
